  ...
  return (
    ...
    >
      ...
      <path
        ...
        className="fill-[--olive-a3] stroke-[--olive-a8]"
      />
      {/* Envelope fold/flap */}
      <path d="m4 6 6.024 5.479a2.915 2.915 0 0 0 3.952 0L20 6" className="stroke-[--olive-a8]" />
    </svg>
  )
}
  ...
  return (
    <li className="flex gap-4">
      ...
      <dl className="flex flex-auto flex-wrap gap-x-2">
        ...
        <dd className="w-full flex-none text-sm font-medium text-heading">{role.company}</dd>
        <dt className="sr-only">Role</dt>
        <dd className="text-xs">{role.title}</dd>
        <dt className="sr-only">Date</dt>
        <dd className="ml-auto text-xs" aria-label={`${startLabel} until ${endLabel}`}>
